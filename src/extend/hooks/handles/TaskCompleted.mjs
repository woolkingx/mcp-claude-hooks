// TaskCompleted.mjs — Handle TaskCompleted hook events
...
export function handle(payload) {
  ...
  const hso = { hookEventName: 'TaskCompleted' }
  ...
  log('debug', `task-completed task_id=${event.task_id} status=${event.status}`)
